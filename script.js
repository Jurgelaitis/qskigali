...
const copy = {
  en: {
    ...
    metaDescription:
      "QS Impact Kigali Council is a youth-led organization in Kigali, Rwanda advancing climate action, education, the STAY & RISE Initiative, safer communities, partnerships, and verified donation support.",
    ...
    programSponsorshipAlt: "QS Impact Kigali Council team members with a student supported through the STAY & RISE Initiative",
    programSponsorshipLabel: "Student continuity & leadership",
    programSponsorshipTitle: "STAY & RISE Initiative",
    programSponsorshipTagline: "Keeping Students in School. Building Future Leaders.",
    programSponsorshipCopy:
      "A long-term student success program helping secondary-school learners overcome financial barriers, complete their education, and grow through mentorship, leadership, and career development.",
    programSponsorshipPoint1: "Target: 50 students supported through graduation by 2030.",
    programSponsorshipPoint2: "5 students are currently enrolled in the initiative.",
    programSponsorshipPoint3: "5 additional students planned for the 2026-2027 academic year.",
    ...
    impactStudents: "students supported through the STAY & RISE Initiative",
    ...
    partnersIntro:
      "QS Impact Kigali Council is seeking partners who can help sustain tree survival, expand school programs, grow the STAY & RISE Initiative, fund safety infrastructure, and strengthen youth-led green action across Rwanda.",
    ...
    pathwayStudentsTitle: "Support STAY & RISE",
    pathwayStudentsCopy:
      "Help students remain in school through graduation and access mentorship, leadership, and career-development opportunities.",
    ...
    supportRowStudentsTitle: "STAY & RISE Initiative",
    supportRowStudentsPurpose: "Keep students in school and develop confident future leaders.",
    supportRowStudentsUse: "School fees, essential learning needs, mentorship, and career development.",
    ...
    interestSponsorship: "STAY & RISE Initiative",
  ...
  rw: {
    ...
    metaDescription:
      "QS Impact Kigali Council ni umuryango uyobowe n'urubyiruko i Kigali, ukora ku kurengera ikirere, uburezi, STAY & RISE Initiative, umutekano w'abaturage, ubufatanye n'inkunga igenzuwe.",
    ...
    programSponsorshipAlt: "Abagize QS Impact Kigali Council bari kumwe n'umunyeshuri ufashwa na STAY & RISE Initiative",
    programSponsorshipLabel: "Gukomeza kwiga n'ubuyobozi",
    programSponsorshipTitle: "STAY & RISE Initiative",
    programSponsorshipTagline: "Gufasha abanyeshuri kuguma mu ishuri. Kubaka abayobozi b'ejo hazaza.",
    programSponsorshipCopy:
      "Gahunda ndende yo guteza imbere abanyeshuri, ibafasha gutsinda inzitizi z'ubushobozi bw'amafaranga, kurangiza amashuri no gukura binyuze mu bujyanama, ubuyobozi no gutegura umwuga.",
    programSponsorshipPoint1: "Intego: gufasha abanyeshuri 50 kugeza barangije amashuri mu 2030.",
    programSponsorshipPoint2: "Abanyeshuri 5 basanzwe bari muri iyi gahunda.",
    ...
    impactStudents: "abanyeshuri bafashwa binyuze muri STAY & RISE Initiative",
    ...
    partnersIntro:
      "QS Impact Kigali Council irashaka abafatanyabikorwa bafasha kurinda ibiti, kwagura gahunda z'amashuri, gukomeza STAY & RISE Initiative, gutera inkunga ibikorwa by'umutekano no gukomeza ibikorwa by'u Rwanda rwatsi biyobowe n'urubyiruko.",
    ...
    pathwayStudentsTitle: "Shyigikira STAY & RISE",
    pathwayStudentsCopy:
      "Fasha abanyeshuri gukomeza kwiga kugeza barangije no kubona ubujyanama, amahugurwa y'ubuyobozi no gutegura umwuga.",
    ...
    supportRowStudentsTitle: "STAY & RISE Initiative",
    supportRowStudentsPurpose: "Gufasha abanyeshuri kuguma mu ishuri no kubaka abayobozi b'ejo hazaza bizeye ubushobozi bwabo.",
    supportRowStudentsUse: "Amafaranga y'ishuri, ibikoresho by'ingenzi, ubujyanama no gutegura umwuga.",
    supportRowTreesTitle: "1000 Trees Initiative",
