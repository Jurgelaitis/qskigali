...
const copy = {
  en: {
    ...
    metaDescription:
      "QS Impact Kigali Council is a youth-led organization in Kigali, Rwanda advancing SDG-driven climate action, education, safer communities, and partnerships.",
  ...
  rw: {
    ...
    metaDescription:
      "QS Impact Kigali Council ni umuryango uyobowe n'urubyiruko i Kigali, ukora ku bikorwa bya SDGs, kurengera ikirere, uburezi, umutekano w'abaturage n'ubufatanye.",
    ...
    partnersIntro:
      "QS Impact Kigali Council irashaka abafatanyabikorwa bafasha kurinda ibiti, kwagura gahunda z'amashuri, gutera inkunga ibikorwa by'umutekano no gukomeza ibikorwa by'u Rwanda rwatsi biyobowe n'urubyiruko.",
